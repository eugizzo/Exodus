...
<body>
 <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light bg-primary" id="ftco-navbar">
   <div class="container">
     <a class="navbar-brand" href="index.html">Exodus<span class="text-white">Travel Agency</span></a>
...
<!-- <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('images/bg_1.jpg'); height: 100px;">
...
<section class="ftco-section pt-32">
   <div class="container pt-5">
    <div class="row">

    <?php
     $query = $connect->query("SELECT * FROM destination ORDER BY id DESC LIMIT 12");
       ...
       <div class="col-md-4 ftco-animate">
          <div class="project-wrap">
             <a href="BookingForm.php?id=<?=$row["id"]; ?> " class="img" style="background-image: url('<?php echo $imageURL; ?>');">
                <span class="price">frw <?php echo $row["price"] ?>/person</span>
            </a>
            <div class="text p-4">
                ...
                <ul>
                   ...
                   <li><span class="flaticon-mountains"></span>Near <?php echo $row["near"] ?></li>
               </ul>
           </div>
       </div>
   </div>
