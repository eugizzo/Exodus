        ...
        <div class="sidebar pe-4 pb-3 ">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-calendar me-2"></i>Post Event</a>
                        <div class="dropdown-menu bg-transparent border-0" style="padding-left: 30px;">
                            ...
                            ?>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><?= $files->date; ?></td>
                                        <td>
                                            <a href="edit.php?id=<?= $files->id; ?>" style="padding-right: 10px;"><img src="../img/edit.png" style="width:20px; height:auto;"></a>
                                            <a href="delete.php?id=<?= $files->id; ?>" onclick="return confirm('Are you sure you want to delete this news with permission permanently? click Ok to continue or click Cancel')"><img src="../img/delete.png" style="width:30px; height:auto"></a>
                                        </td>
                                    </tr>
