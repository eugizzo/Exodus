           ...
           <div class="col-sm-1"></div>
            <div class="col-sm-10 "style="padding-top: 15px;">
                <div class="bg-light rounded h-100 p-3">
                    <h3 class="mb-4" style="padding-top: 15px;"><i>list of people BOOKING</i></h3>
        ...
        <th scope="row"><?php echo $i ?></th>
         <td><?=$destination->title; ?>/<?=$destination->location; ?></td>                 
            ...
            <td><?=$destination->name; ?></td>
             ...
             <td><button onclick="updateStatus(<?=$destination->id;?>)" id="statusBtn<?=$destination->id;?>" class="status-btn <?=$destination->status==0?'approve':'disapprove'; ?>"><?=$destination->status==0?'Approve':'Disapprove'; ?></button></td>
